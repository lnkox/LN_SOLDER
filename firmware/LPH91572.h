...
//===============================================================
#define LCD_CS 		PORTD.5 //Выбор чипа
#define LCD_RESET 	PORTD.3 //Сброс
#define LCD_RS 		PORTD.4	//CD - тип передаваемых данных
#define LCD_CLK 	PORTD.6 //Синхронизация
#define LCD_DATA 	PORTD.7 //Данные
